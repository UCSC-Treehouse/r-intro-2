...
We will be working in [RStudio](https://www.rstudio.com/products/rstudio/download/). The easiest way to get started is to go to [RStudio Cloud](https://rstudio.cloud/) and create a new project. 
